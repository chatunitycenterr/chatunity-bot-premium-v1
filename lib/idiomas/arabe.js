...
const smsLista1 = () => { return `🌟 معلومات Chatunity-bot 🌟`}
...
const smsLista7 = () => { return `💬 تثبيت Chatunity-bot 💬`}
...
//_allantilink.js
const smsTextoYT = () => { return '💬 ممتاز chatunity-bot-premium-v1 - WhatsApp '}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام Chatunity-bot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام Chatunity-bot في المجموعات`}
...
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: chatunitycenter@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
...
const smsContacto4 = () => { return 'جهة اتصال Chatunity-bot الرسمية 💬'}
