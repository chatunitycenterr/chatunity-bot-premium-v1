...
const smsLista1 = () => { return `🌟 INFORMATIONS Chatunity-bot 🌟`}
...
const smsLista7 = () => { return `💬 INSTALLER Chatunity-bot 💬`}
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Chatunity-bot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar Chatunity-bot en Grupos`}
...
const smsTex13 = () => { return '*MENU DE INFORMAZIONI*'}
...
//grupo-info.js
const smsGI1 = () => { return '*INFORMAZIONI DEL GRUPO*'}
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: chatunitycenter@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de Chatunity-bot 💬'}
