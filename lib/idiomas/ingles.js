...
const smsLista1 = () => { return `🌟 Chatunity-bot INFORMATION 🌟`}
...
const smsLista7 = () => { return `💬 INSTALL Chatunity-bot 💬`}
...
const smsModP2 = () => { return `Enable function so everyone can use Chatunity-bot`}
const smsModAd1 = () => { return `🛂 ADMIN MODE`}
const smsModAd2 = () => { return `Only Admins will be able to use Chatunity-bot in Groups`}
...
const smsJBInfo2 = () => { return `💖 *The function is stable, if it presents any inconvenience Contact the mail: chatunitycenter@gmail.com*\n💝 *You can make a voluntary donation by PayPal: ${global.paypal}*\n\n*Thank you very much for the support ${global.packname}*`}
...
const smsContacto4 = () => { return 'Chatunity-bot Official Contact 💬'}
