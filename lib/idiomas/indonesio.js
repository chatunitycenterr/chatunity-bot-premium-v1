...
const smsLista1 = () => { return `🌟 INFORMASI Chatunity-bot 🌟`}
...
const smsLista7 = () => { return `💬 PASANG Chatunity-bot 💬`}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan Chatunity-bot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan Chatunity-bot di Grup`}
...
const smsContacto4 = () => { return 'Kontak Resmi Chatunity-bot 💬'}
