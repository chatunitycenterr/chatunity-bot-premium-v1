...
const smsLista1 = () => { return `🌟 INFORMAZIONI Chatunity-bot 🌟`}
...
const smsLista7 = () => { return `💬 INSTALLA Chatunity-bot 💬`}
...
//_allantilink.js
const smsTextoYT = () => { return '💬 Super chatunity-bot-premium-v1 - WhatsApp '}
...
const smsModP2 = () => { return `Abilita la funzione in modo che tutti possano usare Chatunity-bot`}
const smsModAd1 = () => { return `🛂 MODALITA' AMMINISTRATORE`}
const smsModAd2 = () => { return `Solo gli amministratori potranno usare Chatunity-bot nei gruppi`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n*QUESTO E' UN BOT DI WHATSAPP CHE TI AIUTA A FARE DIVERSE ATTIVITA'🪄 CHE SIA IN PRIVATO O IN GRUPPO TI DIVERTITAI 🎈 CON LE SUE MOLTEPLICI FUNZIONALITA', GODITI Chatunity-bot!!! 😸\n\n💖 Chatunity-bot E' STATO INVITATO DA*:\n@${user}`}
...
const smsJBInfo2 = () => { return `💖 *La funzione e' stabile, se presenta qualche inconveniente Contatta la mail: chatunitycenter@gmail.com*\n💝 *Puoi fare una donazione volontaria tramite PayPal: ${global.paypal}*\n\n*Grazie mille per il supporto ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contatto Ufficiale Chatunity-bot 💬'}
