...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO Chatunity-bot 🌟`}
...
const smsLista7 = () => { return `💬 INSTALAR O Chatunity-bot 💬`}
...
const smsModP2 = () => { return `Ativar função para que todos possam usar o Chatunity-bot`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o Chatunity-bot em Grupos`}
...
const smsJBInfo2 = () => { return `💖 *A função é estável, se apresentar algum inconveniente Entre em contato com o e-mail: chatunitycenter@gmail.com*\n💝 *Você pode fazer uma doação voluntária pelo PayPal: ${global.paypal}*\n\n*Muito obrigado pelo apoio ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contato Oficial Chatunity-bot 💬'}
