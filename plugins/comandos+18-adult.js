...
let resError = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/tetas.json`)).data   
...
let resError = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/booty.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/ecchi.json`)).data  
...
let res = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/furro.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let resError = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/imagenlesbians.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/panties.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let resError = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/pene.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/porno.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, res, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let rawjsonn = ['https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/tetas.json', 'https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/booty.json', 'https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/imagenlesbians.json', 'https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/panties.json', 'https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/porno.json'] 
...
let res = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/pechos.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
...
let res = (await axios.get(`https://raw.githubusercontent.com/HasamiAini/wabot_takagisan/main/whatsapp%20bot%20takagisan/whatsapp%20bot%20takagisan/lib/Yaoi.json`)).data  //`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/yaoi.json`
let enlace = await res[Math.floor(res.length * Math.random())]
...
let res = (await axios.get(`https://raw.githubusercontent.com/ChatUnity/chatunity-bot-premium-v1/master/src/JSON/yuri.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, m)}
