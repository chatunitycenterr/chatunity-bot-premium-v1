...
if (esProhibido) {
user.banned = true;
await conn.reply(m.chat, mid.mAdvertencia + `@${m.sender.split`@`[0]} È stato bannato, per ordine del mio proprietario non potete usare il bot.\n\nPOTETE USARE SOLO I SEGUENTI COMANDI:\n- /jadibot\n- /jadibot code\n- /estado\n\n⚠️ \`\`\`Verrai bannato(a)\`\`\`
\`\`\` ⚠️`, m);
return !1;
}
return !0;
