// Botones interactivos adptados y funcionando por chatunity (ChatUnity)
...
title: "VER LISTA",
description: "Infórmate por medios oficiales sobre Chatunity-bot",
sections: [
{ title: "ℹ️ Información", highlight_label: "Popular",
rows: [
{ header: "✅ Redes", title: "🔓 Para: Todos", description: "Infórmate por medios oficiales sobre Chatunity-bot", id: usedPrefix + "cuentasgb" },
{ header: "📢 Grupos/Canales", title: "🔓 Para: Todos", description: "¡Te esperamos!", id: usedPrefix + "grupos" },
{ header: "🎁 Donar", title: "🔓 Para: Todos", description: "Chatunity-bot se mantiene funcionando gracias a donaciones ¡tú también puedes sumarte apoyando el proyecto!", id: usedPrefix + "donar" }
]},
...
{ header: "💬 Estado", title: "🔓 Para: Todos", description: "Conoce en que estado se encuentra Chatunity-bot", id: usedPrefix + "estado" }
]},
...
┃
┃✅ *_CUENTAS OFICIALES Chatunity-bot_* ✅
┃➺ _${usedPrefix}cuentasChatunity-bot | cuentasgb_
┃
*╰━━━━━━━━━━━━━⬣*`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 💬 𝗦𝘂𝗽𝗲𝗿 chatunity-bot-premium-v1 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu}}}) 
