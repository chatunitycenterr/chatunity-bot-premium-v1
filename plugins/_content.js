...
let pp = await this.profilePictureUrl(who, 'image').catch(_ => "https://i.ibb.co/JFKRG2gv/chatunity-premium.jpg")
...
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'developed by chatunity', orderTitle: 'Bang', thumbnail: gataMenu, sellerJid: '0@s.whatsapp.net' }}}
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '💬 𝗦𝘂𝗽𝗲𝗿 chatunity-bot-premium-v1 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
let dos = [enlace, enlace2]  
global.wait = "⌛ *`Caricamento...`*\n*✪✦✦⊹⊹⊹⊹⊹⊹⊹⊹✪* `20%`"
global.waitt = "⏳ *`Caricamento....`*\n*✪✦✦✦✦⊹⊹⊹⊹⊹⊹✪* `40%`"
global.waittt = "⌛ *`Caricamento...`*\n*✪✦✦✦✦✦✦⊹⊹⊹⊹✪* `60%`"
global.waitttt = "⏳ *`Caricamento....`*\n*✪✦✦✦✦✦✦✦✦⊹⊹✪* `80%`"
global.waittttt = "⌛ *`Elaborazione...`*\n*✪✦✦✦✦✦✦✦✦✦✦✪* `100%`"
global.destraba = `⏰SBLOCCO⏰*
li.DESTRAVip.to
2024 🦍💨
...
global.bot = "wa.me/8619858371809"
...
global.canalIdGB = ["120363259442839354@newsletter", "120363259442839354@newsletter", "120363259442839354@newsletter", "120363259442839354@newsletter"]
global.canalNombreGB = ["ChatUnity 💬", "ChatUnity 💬", "ChatUnity 💬", "ChatUnity 💬"]
...
global.img = 'https://i.ibb.co/JFKRG2gv/chatunity-premium.jpg'
